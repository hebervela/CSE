world_map = {
    'LIVING ROOM 1': {
        'NAME': "Living room",
        'DESCRIPTION': "This is the living room the main room of the house, you have one path to the south.",
        'PATHS': {
            'SOUTH': "DINING ROOM",
}
    },
    'DINING ROOM': {
        ...
        'DESCRIPTION': "This is the dining room, there is food on the table, "
                       "your only exits are to the kitchen east "
                       "or the guest room west ",
        'PATHS': {
            'EAST': "KITCHEN",
            'WEST': "GUEST ROOM",
        }
